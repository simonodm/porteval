...
namespace PortEval.Infrastructure.Migrations
{
    ...
    [Migration("20230308204417_UniqueConstraintsAdded")]
            ...
            modelBuilder.Entity("PortEval.Domain.Models.Entities.CurrencyExchangeRate", b =>
                {
                    ...
                    b.HasIndex("CurrencyFromCode", "CurrencyToCode", "Time")
                        .IsUnique()
                        .HasFilter("[CurrencyFromCode] IS NOT NULL AND [CurrencyToCode] IS NOT NULL");
            ...
            modelBuilder.Entity("PortEval.Domain.Models.Entities.DataImport", b =>
                {
                    ...
                    b.Property<string>("ErrorLogPath")
                        .HasMaxLength(256)
            ...
            modelBuilder.Entity("PortEval.Domain.Models.Entities.Exchange", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Symbol = "AEX",
                            Name = "NYSE Euronext Amsterdam",
                            Version = 0
                        },
                        new
                        {
                            Symbol = "ALBRTA",
                            Name = "Alberta Stock Exchange",
                            Version = 0
                        },
                        new
                        {
                        ...
                        {
                            Symbol = "MF",
                            Name = "Madrid Fixed Income Market",
                            Version = 0
                        },
                        new
                        {
                        ...
                        {
                            Symbol = "MIL",
                            Name = "Borsa Italiana Milan Stock Exchange",
                            Version = 0
                        },
                        new
                        {
                            Symbol = "MSE",
                            Name = "Madrid SE C.A.T.S.",
                            Version = 0
                        },
                        new
                        {
                        ...
                        {
                            Symbol = "OPRA",
                            Name = "Options Pricing Authority Options Chains",
                            Version = 0
                        },
                        new
                        {
                        ...
                        {
                            Symbol = "SAO",
                            Name = "Sao Paolo Stock Exchange (BOVESPA)",
                            Version = 0
                        },
                        new
                        {
                        ...
                        {
                            Symbol = "WBAG",
                            Name = "Vienna Stock Exchange (Wiener Borse)",
                            Version = 0
                        },
                        new
                        {
