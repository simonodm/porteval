...
public class InstrumentRepository : IInstrumentRepository
{
    ...
    public void Delete(Instrument instrument)
    {
        var foundInstrumentLines = _context.ChartLines
            .Where(line => EF.Property<string>(line, "Line_Type") == "Instrument" &&
                           (line as ChartLineInstrument).InstrumentId == instrument.Id);
        var foundPositionLines = _context.ChartLines
            .Where(line => EF.Property<string>(line, "Line_Type") == "Position")
            .Join(_context.Positions.Where(pos => pos.InstrumentId == instrument.Id),
                line => (line as ChartLinePosition).PositionId, position => position.Id, (line, position) => line);
