...
public class FinancialDataFetcher : IFinancialDataFetcher
{
    ...
    /// <summary>
    ///     Initializes the financial data fetcher.
    /// </summary>
    /// <param name="fetcher">The data fetcher client to use for data retrieval.</param>
    ...
    /// <inheritdoc />
    public async Task<IEnumerable<PricePoint>> GetHistoricalDailyPricesAsync(string symbol, string currencyCode,
        DateTime from,
        DateTime to)
    {
        ...
        var response =
            await _fetcher
                .ProcessRequestAsync<HistoricalDailyInstrumentPricesRequest, IEnumerable<PricePoint>>(request);
        return response.Result;
    }

    /// <inheritdoc />
    public async Task<IEnumerable<PricePoint>> GetIntradayPricesAsync(string symbol, string currencyCode, DateTime from,
        DateTime to,
        IntradayInterval interval = IntradayInterval.OneHour)
    {
        ...
        var response =
            await _fetcher.ProcessRequestAsync<IntradayInstrumentPricesRequest, IEnumerable<PricePoint>>(request);
        return response.Result;
    }
        ...
        DateTime from, DateTime to)
    {
        ...
        var response =
            await _fetcher.ProcessRequestAsync<HistoricalDailyCryptoPricesRequest, IEnumerable<PricePoint>>(request);
        return response.Result;
    }
        ...
        DateTime from, DateTime to, IntradayInterval interval = IntradayInterval.OneHour)
    {
        ...
        var response =
            await _fetcher.ProcessRequestAsync<IntradayCryptoPricesRequest, IEnumerable<PricePoint>>(request);
        return response.Result;
    }
    ...
    /// <inheritdoc />
    public async Task<IEnumerable<ExchangeRates>> GetHistoricalDailyExchangeRatesAsync(string baseCurrency,
        DateTime from, DateTime to)
    {
        ...
        var response =
            await _fetcher
                .ProcessRequestAsync<HistoricalDailyExchangeRatesRequest, IEnumerable<ExchangeRates>>(request);
        return response.Result;
    }
