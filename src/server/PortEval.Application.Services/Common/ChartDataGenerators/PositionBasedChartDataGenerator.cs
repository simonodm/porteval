...
namespace PortEval.Application.Features.Common.ChartDataGenerators
{
    ...
    public abstract class PositionBasedChartDataGenerator : ChartDataGeneratorBase
    {
        ...
        protected virtual IEnumerable<EntityChartPointDto> ChartValue(IEnumerable<PositionPriceListData> positionsPriceListData,
        ...
        /// <param name="frequency">Chart point interval</param>
        /// <returns>An <see cref="IEnumerable{T}"/> containing chart line points.</returns>
        protected virtual IEnumerable<EntityChartPointDto> ChartProfit(IEnumerable<PositionPriceListData> positionsPriceListData, DateRangeParams dateRange, AggregationFrequency frequency)
        {
            var adjustedDateRange = LimitDateRangeToFirstTransaction(positionsPriceListData, dateRange);
            var ranges = GetAggregatedRanges(adjustedDateRange.From, adjustedDateRange.To, frequency);
        ...
        /// <param name="frequency">Chart point interval</param>
        /// <returns>An <see cref="IEnumerable{T}"/> containing chart line points.</returns>
        protected virtual IEnumerable<EntityChartPointDto> ChartPerformance(IEnumerable<PositionPriceListData> positionsPriceListData, DateRangeParams dateRange, AggregationFrequency frequency)
        {
            var adjustedDateRange = LimitDateRangeToFirstTransaction(positionsPriceListData, dateRange);
            var ranges = GetAggregatedRanges(adjustedDateRange.From, adjustedDateRange.To, frequency);
            ranges = ranges.Prepend(new DateRangeParams { From = adjustedDateRange.From, To = adjustedDateRange.From });
        ...
        /// <param name="frequency">Chart point interval</param>
        /// <returns>An <see cref="IEnumerable{T}"/> containing chart line points.</returns>
        protected virtual IEnumerable<EntityChartPointDto> ChartAggregatedProfit(IEnumerable<PositionPriceListData> positionsPriceListData, DateRangeParams dateRange, AggregationFrequency frequency)
        {
            var adjustedDateRange = LimitDateRangeToFirstTransaction(positionsPriceListData, dateRange);
            var ranges = GetAggregatedRanges(adjustedDateRange.From, adjustedDateRange.To, frequency);
            var result = BuildChartFromPositionData(
        ...
        /// <param name="frequency">Chart point interval</param>
        /// <returns>An <see cref="IEnumerable{T}"/> containing chart line points.</returns>
        protected virtual IEnumerable<EntityChartPointDto> ChartAggregatedPerformance(IEnumerable<PositionPriceListData> positionsPriceListData, DateRangeParams dateRange, AggregationFrequency frequency)
        {
            var adjustedDateRange = LimitDateRangeToFirstTransaction(positionsPriceListData, dateRange);
            var ranges = GetAggregatedRanges(adjustedDateRange.From, adjustedDateRange.To, frequency);
            var result = BuildChartFromPositionData(
        ...
        private IEnumerable<EntityChartPointDto> BuildChartFromPositionData(IEnumerable<PositionPriceListData> positionsPriceListData,
            IEnumerable<DateRangeParams> ranges, Func<IEnumerable<PositionPriceRangeData>, DateRangeParams, decimal> callback)
        {
