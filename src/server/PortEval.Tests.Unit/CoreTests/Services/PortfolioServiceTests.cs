...
namespace PortEval.Tests.Unit.CoreTests.Services
{
    public class PortfolioServiceTests
    {
        ...
        private Mock<IPortfolioQueries> _portfolioQueries;
        ...
        private Mock<IPortfolioStatisticsCalculator> _statisticsCalculator;

        private Mock<IPortfolioChartDataGenerator> _chartDataGenerator;
        ...
        public PortfolioServiceTests()
        {
            ...
            _positionService
                ...
                .ReturnsAsync(OperationResponseHelper.GenerateSuccessfulOperationResponse(_fixture.CreateMany<PositionDto>()));
            _positionService
            ...
            _positionService
                ...
                .ReturnsAsync(OperationResponseHelper.GenerateSuccessfulOperationResponse(_fixture.Create<PositionPriceListData>()));
            _positionService
                .Setup(m => m.GetPositionPriceRangeDataAsync(It.IsAny<PositionDto>(), It.IsAny<DateRangeParams>()))
                .ReturnsAsync(OperationResponseHelper.GenerateSuccessfulOperationResponse(_fixture.Create<PositionPriceRangeData>()));
            ...
            _currencyConverter
                .Setup(m => m.ConvertInstrumentPrices(It.IsAny<IEnumerable<InstrumentPriceDto>>(),
                    It.IsAny<IEnumerable<CurrencyExchangeRateDto>>()))
                .Returns<IEnumerable<InstrumentPriceDto>, IEnumerable<CurrencyExchangeRateDto>>((prices, rates) =>
                    prices);
            _currencyConverter
                .Setup(m => m.ConvertTransactions(It.IsAny<IEnumerable<TransactionDto>>(),
                    It.IsAny<IEnumerable<CurrencyExchangeRateDto>>()))
                .Returns<IEnumerable<TransactionDto>, IEnumerable<CurrencyExchangeRateDto>>((transactions, rates) =>
                    transactions);
        }
        ...
        public async Task ChartPortfolioValueAsync_ReturnsCorrectValueChart_WhenPortfolioExists()
        {
            ...
            _chartDataGenerator
                .Setup(c => c.ChartValue(It.IsAny<PortfolioPositionsPriceListData>(), It.IsAny<DateRangeParams>(), It.IsAny<AggregationFrequency>()))
                .Returns(valueChart);

            var sut = _fixture.Create<PortfolioService>();
            var result = await sut.ChartPortfolioValueAsync(_fixture.Create<int>(), _fixture.Create<DateRangeParams>(), _fixture.Create<AggregationFrequency>());
        ...
        public async Task ChartPortfolioProfitAsync_ReturnsCorrectProfitChart_WhenPortfolioExists()
        {
            ...
            _chartDataGenerator
                .Setup(c => c.ChartProfit(It.IsAny<PortfolioPositionsPriceListData>(), It.IsAny<DateRangeParams>(), It.IsAny<AggregationFrequency>()))
                .Returns(profitChart);

            var sut = _fixture.Create<PortfolioService>();
            var result = await sut.ChartPortfolioProfitAsync(_fixture.Create<int>(), _fixture.Create<DateRangeParams>(), _fixture.Create<AggregationFrequency>());
        ...
        public async Task ChartPortfolioPerformanceAsync_ReturnsCorrectPerformanceChart_WhenPortfolioExists()
        {
            ...
            _chartDataGenerator
                .Setup(c => c.ChartPerformance(It.IsAny<PortfolioPositionsPriceListData>(), It.IsAny<DateRangeParams>(), It.IsAny<AggregationFrequency>()))
                .Returns(performanceChart);

            var sut = _fixture.Create<PortfolioService>();
            var result = await sut.ChartPortfolioPerformanceAsync(_fixture.Create<int>(), _fixture.Create<DateRangeParams>(), _fixture.Create<AggregationFrequency>());
        ...
        public async Task ChartPortfolioAggregatedProfitAsync_ReturnsCorrectAggregatedProfitChart_WhenPortfolioExists()
        {
            ...
            _chartDataGenerator
                .Setup(c => c.ChartAggregatedProfit(It.IsAny<PortfolioPositionsPriceListData>(), It.IsAny<DateRangeParams>(), It.IsAny<AggregationFrequency>()))
                .Returns(aggregatedProfitChart);

            var sut = _fixture.Create<PortfolioService>();
            var result = await sut.ChartPortfolioAggregatedProfitAsync(_fixture.Create<int>(), _fixture.Create<DateRangeParams>(), _fixture.Create<AggregationFrequency>());
        ...
        public async Task ChartPortfolioAggregatedPerformanceAsync_ReturnsCorrectAggregatedPerformanceChart_WhenPortfolioExists()
        {
            ...
            _chartDataGenerator
                .Setup(c => c.ChartAggregatedPerformance(It.IsAny<PortfolioPositionsPriceListData>(), It.IsAny<DateRangeParams>(), It.IsAny<AggregationFrequency>()))
                .Returns(aggregatedPerformanceChart);

            var sut = _fixture.Create<PortfolioService>();
            var result = await sut.ChartPortfolioAggregatedPerformanceAsync(_fixture.Create<int>(), _fixture.Create<DateRangeParams>(), _fixture.Create<AggregationFrequency>());
