...
public class InstrumentPriceServiceTests
{
    ...
    public async Task GetInstrumentPricesPageAsync_ReturnsInstrumentPricePage_WhenInstrumentExists()
    {
        ...
        _instrumentQueries
            .Setup(m => m.GetInstrumentPricesPageAsync(It.IsAny<int>(), It.IsAny<DateTime>(), It.IsAny<DateTime>(),
                paginationParams, It.IsAny<AggregationFrequency?>()))
        ...
        var result = await sut.GetInstrumentPricesPageAsync(_fixture.Create<int>(), paginationParams,
            _fixture.Create<DateRangeParams>());
    ...
    public async Task GetInstrumentPricesPageAsync_ReturnsInstrumentPricePage_WhenInstrumentExistsAndCompressedIsTrue()
    {
        ...
        _instrumentQueries
            .Setup(m => m.GetInstrumentPricesPageCompressedAsync(It.IsAny<int>(), It.IsAny<DateTime>(),
                It.IsAny<DateTime>(), paginationParams, It.IsAny<AggregationFrequency?>()))
            .ReturnsAsync(pricesToTake);
        _instrumentQueries
        ...
        var result = await sut.GetInstrumentPricesPageAsync(_fixture.Create<int>(), paginationParams,
            _fixture.Create<DateRangeParams>(), true);
    ...
    public async Task GetInstrumentPricesPageAsync_ReturnsNotFound_WhenInstrumentDoesNotExist()
    {
        ...
        var result = await sut.GetInstrumentPricesPageAsync(_fixture.Create<int>(), _fixture.Create<PaginationParams>(),
            _fixture.Create<DateRangeParams>());
