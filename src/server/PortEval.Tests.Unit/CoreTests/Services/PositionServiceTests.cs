...
{
    private readonly Mock<IPositionBreakEvenPointCalculator> _bepCalculator;
    ...
    private readonly Mock<IPositionChartDataGenerator> _chartDataGenerator;
    ...
    private readonly Mock<IPositionStatisticsCalculator> _statisticsCalculator;
    ...
    public PositionServiceTests()
    {
        ...
        _transactionService
            ...
            .ReturnsAsync(
                OperationResponseHelper.GenerateSuccessfulOperationResponse(_fixture.CreateMany<TransactionDto>()));
        ...
        _priceService
            ...
            .ReturnsAsync(
                OperationResponseHelper.GenerateSuccessfulOperationResponse(_fixture.CreateMany<InstrumentPriceDto>()));
        _priceService
        ...
        _priceService
            ...
            .ReturnsAsync(
                OperationResponseHelper.GenerateSuccessfulOperationResponse(_fixture.Create<InstrumentPriceDto>()));
    ...
    public async Task ChartPositionValueAsync_ReturnsCorrectValueChart_WhenPositionExists()
    {
        ...
        var sut = _fixture.Create<PositionService>();
        var result = await sut.ChartPositionValueAsync(_fixture.Create<int>(), dateRange,
    ...
    public async Task ChartPositionValueAsync_ReturnsNotFound_WhenPositionDoesNotExist()
    {
        ...
        var sut = _fixture.Create<PositionService>();
        var result = await sut.ChartPositionValueAsync(_fixture.Create<int>(), _fixture.Create<DateRangeParams>(),
            _fixture.Create<AggregationFrequency>());
    ...
    public async Task ChartPositionProfitAsync_ReturnsCorrectProfitChart_WhenPositionExists()
    {
        ...
        var sut = _fixture.Create<PositionService>();
        var result = await sut.ChartPositionProfitAsync(_fixture.Create<int>(), dateRange,
            _fixture.Create<AggregationFrequency>());
    ...
    public async Task ChartPositionProfitAsync_ReturnsNotFound_WhenPositionDoesNotExist()
    {
        ...
        var sut = _fixture.Create<PositionService>();
        var result = await sut.ChartPositionProfitAsync(_fixture.Create<int>(), _fixture.Create<DateRangeParams>(),
            _fixture.Create<AggregationFrequency>());
    ...
    public async Task ChartPositionPerformanceAsync_ReturnsCorrectPerformanceChart_WhenPositionExists()
    {
        ...
        _chartDataGenerator
            .Setup(c => c.ChartPerformance(It.IsAny<PositionPriceListData>(), dateRange,
                It.IsAny<AggregationFrequency>()))
            .Returns(performanceChart);

        var sut = _fixture.Create<PositionService>();
        var result = await sut.ChartPositionPerformanceAsync(_fixture.Create<int>(), dateRange,
            _fixture.Create<AggregationFrequency>());
    ...
    public async Task ChartPositionPerformanceAsync_ReturnsNotFound_WhenPositionDoesNotExist()
    {
        ...
        var sut = _fixture.Create<PositionService>();
        var result = await sut.ChartPositionPerformanceAsync(_fixture.Create<int>(), _fixture.Create<DateRangeParams>(),
            _fixture.Create<AggregationFrequency>());
    ...
    public async Task ChartPositionAggregatedProfitAsync_ReturnsCorrectAggregatedProfit_WhenPositionExists()
    {
        ...
        _chartDataGenerator
            .Setup(c => c.ChartAggregatedProfit(It.IsAny<PositionPriceListData>(), dateRange,
                It.IsAny<AggregationFrequency>()))
            .Returns(aggregatedProfitChart);

        var sut = _fixture.Create<PositionService>();
        var result = await sut.ChartPositionAggregatedProfitAsync(_fixture.Create<int>(), dateRange,
            _fixture.Create<AggregationFrequency>());
    ...
    public async Task ChartPositionAggregatedProfitAsync_ReturnsNotFound_WhenPositionDoesNotExist()
    {
        ...
        var sut = _fixture.Create<PositionService>();
        var result = await sut.ChartPositionAggregatedProfitAsync(_fixture.Create<int>(),
    ...
    public async Task ChartPositionAggregatedPerformanceAsync_ReturnsCorrectAggregatedPerformance_WhenPositionExists()
    {
        ...
        _chartDataGenerator
            .Setup(c => c.ChartAggregatedPerformance(It.IsAny<PositionPriceListData>(), dateRange,
                It.IsAny<AggregationFrequency>()))
            .Returns(aggregatedPerformanceChart);

        var sut = _fixture.Create<PositionService>();
        var result = await sut.ChartPositionAggregatedPerformanceAsync(_fixture.Create<int>(), dateRange,
            _fixture.Create<AggregationFrequency>());
    ...
    public async Task ChartPositionAggregatedPerformanceAsync_ReturnsNotFound_WhenPositionDoesNotExist()
    {
        ...
        var sut = _fixture.Create<PositionService>();
        var result = await sut.ChartPositionAggregatedPerformanceAsync(_fixture.Create<int>(),
            _fixture.Create<DateRangeParams>(), _fixture.Create<AggregationFrequency>());
