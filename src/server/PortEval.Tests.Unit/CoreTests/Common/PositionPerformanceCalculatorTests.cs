...
public class PositionPerformanceCalculatorTests
{
    ...
    public void CalculateIrr_ReturnsCorrectRateOfReturn(IEnumerable<PositionPriceRangeData> positionsPriceData,
        DateTime start, DateTime end, decimal expectedIrr)
    {
