...
public class CurrencyConverterTests
{
    ...
    public void ConvertChartPoints_ConvertsChartPointsAccordingToProvidedExchangeRates()
    {
        ...
        Assert.Collection(result,
            point => { Assert.Equal(chartPoints[0].Value * exchangeRates[0].ExchangeRate, point.Value); },
            point => { Assert.Equal(chartPoints[1].Value * exchangeRates[1].ExchangeRate, point.Value); },
            point => { Assert.Equal(chartPoints[2].Value * exchangeRates[2].ExchangeRate, point.Value); },
            point => { Assert.Equal(chartPoints[3].Value * exchangeRates[2].ExchangeRate, point.Value); },
            point => { Assert.Equal(chartPoints[4].Value * exchangeRates[2].ExchangeRate, point.Value); });
    }
    ...
    public void ConvertTransactions_ConvertsTransactionsAccordingToProvidedExchangeRates()
    {
        ...
        Assert.Collection(result,
            t => { Assert.Equal(transactions[0].Price * exchangeRates[0].ExchangeRate, t.Price); },
            t => { Assert.Equal(transactions[1].Price * exchangeRates[2].ExchangeRate, t.Price); });
    }
    ...
    public void ConvertInstrumentPrices_ConvertsPricesAccordingToProvidedExchangeRates()
    {
        ...
        Assert.Collection(result, t => { Assert.Equal(prices[0].Price * exchangeRates[0].ExchangeRate, t.Price); },
            t => { Assert.Equal(prices[1].Price * exchangeRates[2].ExchangeRate, t.Price); });
    }
