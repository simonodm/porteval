...
namespace PortEval.Tests.Unit.DataFetcherTests
{
    public class RequestHandlerTests
    {
        ...
        private Mock<TestFinancialApi> CreateWorkingApiMock(IFixture _fixture)
        {
            var api = _fixture.Create<Mock<TestFinancialApi>>();
            api
        ...
        private Mock<TestFinancialApi> CreateTemporarilyFailingApiMock(IFixture _fixture)
        {
            var api = _fixture.Create<Mock<TestFinancialApi>>();
            api
        ...
        private Mock<TestFinancialApi> CreateFailingApiMock(IFixture _fixture)
        {
            var api = _fixture.Create<Mock<TestFinancialApi>>();
            api
                .Setup(m => m.Process(It.IsAny<TestRequest>()))
        ...
        private Mock<TestFinancialApi> CreateUnresponsiveApiMock(IFixture _fixture)
        {
            var api = _fixture.Create<Mock<TestFinancialApi>>();
            api
                .Setup(m => m.Process(It.IsAny<TestRequest>()))
