...
namespace PortEval.Tests.Unit.ControllerTests
{
    public class InstrumentControllerTests
    {
        ...
        public async Task GetInstrumentChartedPrices_ReturnsChartedPrices_WhenInstrumentExists()
        {
            ...
            _instrumentService.Verify(m => m.ChartInstrumentPricesAsync(instrumentId, dateRange, aggregationFrequency, currencyCode));
        ...
        public async Task GetInstrumentChartedProfit_ReturnsChartedProfit_WhenInstrumentExists()
        {
            ...
            _instrumentService.Verify(m => m.ChartInstrumentProfitAsync(instrumentId, dateRange, aggregationFrequency, currencyCode));
        ...
        public async Task GetInstrumentChartedPerformance_ReturnsChartedPerformance_WhenInstrumentExists()
        {
            ...
            _instrumentService.Verify(m => m.ChartInstrumentPerformanceAsync(instrumentId, dateRange, aggregationFrequency));
        ...
        public async Task GetInstrumentAggregatedPerformance_ReturnsAggregatedPerformance_WhenInstrumentExists()
        {
            ...
            _instrumentService.Verify(m => m.ChartInstrumentAggregatedPerformanceAsync(instrumentId, dateRange, aggregationFrequency));
        ...
        public async Task GetInstrumentAggregatedProfit_ReturnsAggregatedProfit_WhenInstrumentExists()
        {
            ...
            _instrumentService.Verify(m => m.ChartInstrumentAggregatedProfitAsync(instrumentId, dateRange, aggregationFrequency, currencyCode));
