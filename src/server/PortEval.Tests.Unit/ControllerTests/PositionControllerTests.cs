...
public class PositionControllerTests
{
    ...
    public async Task GetPositionChartedValue_ReturnsChartedValue_WhenPositionExists()
    {
        ...
        _positionService.Verify(m =>
            m.ChartPositionValueAsync(positionId, dateRange, aggregationFrequency, currencyCode));
    ...
    public async Task GetPositionChartedProfit_ReturnsChartedProfit_WhenPositionExists()
    {
        ...
        _positionService.Verify(m =>
            m.ChartPositionProfitAsync(positionId, dateRange, aggregationFrequency, currencyCode));
    ...
    public async Task GetPositionAggregatedPerformance_ReturnsAggregatedPerformance_WhenPositionExists()
    {
        ...
        _positionService.Verify(m =>
            m.ChartPositionAggregatedPerformanceAsync(positionId, dateRange, aggregationFrequency));
    ...
    public async Task GetPositionAggregatedProfit_ReturnsAggregatedProfit_WhenPositionExists()
    {
        ...
        _positionService.Verify(m =>
            m.ChartPositionAggregatedProfitAsync(positionId, dateRange, aggregationFrequency, currencyCode));
