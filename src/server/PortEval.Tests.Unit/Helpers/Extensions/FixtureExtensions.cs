...
{
    public static Mock<IFinancialDataFetcher> CreatePriceFetcherMockReturningHistoricalPrices(this IFixture fixture,
    ...
    /// <summary>
    ///     Creates a <see cref="IPositionProfitCalculator" /> mock, the
    ///     <see cref="IPositionProfitCalculator.CalculateProfit" /> of which
    ///     is mocked to return the total amount of transactions which occurred before the time at which the profit is
    ///     calculated,
                ...
                (positionsPriceData, from, to) =>
                    from >= to
                        ...
                        : positionsPriceData.Sum(p => p.Transactions
                            .Where(t => t.Time <= to)
                            .Sum(t => t.Amount *
                                      ((p.PriceAtRangeEnd?.Price ?? 0m) - (p.PriceAtRangeStart?.Price ?? 0m)))
                        )
            );
    ...
    /// <summary>
    ///     Creates a <see cref="IPositionPerformanceCalculator" /> mock, the
    ///     <see cref="IPositionPerformanceCalculator.CalculatePerformance" /> of which
    ///     is mocked to return the the total number of transactions which occurred before the time at which the performance is
    ///     calculated
    /// </summary>
    /// <param name="fixture"></param>
    /// <returns></returns>
    ...
    /// <summary>
    ///     Creates a <see cref="IPositionBreakEvenPointCalculator" /> mock, the
    ///     <see cref="IPositionBreakEvenPointCalculator.CalculatePositionBreakEvenPoint" /> of which
    ...
    public static Mock<IInstrumentQueries> CreateDefaultInstrumentQueriesMock(this IFixture fixture)
    {
        ...
        mock
            .Setup(m => m.GetInstrumentPricesPageAsync(It.IsAny<int>(), It.IsAny<DateTime>(), It.IsAny<DateTime>(),
                It.IsAny<PaginationParams>(), It.IsAny<AggregationFrequency?>()))
            .ReturnsAsync(fixture.CreateMany<InstrumentPriceDto>());
        mock
            .Setup(m => m.GetInstrumentPricesPageCompressedAsync(It.IsAny<int>(), It.IsAny<DateTime>(),
                It.IsAny<DateTime>(), It.IsAny<PaginationParams>(), It.IsAny<AggregationFrequency?>()))
            .ReturnsAsync(fixture.CreateMany<InstrumentPriceDto>());
        mock
            ...
            .ReturnsAsync(fixture.Create<int>());
        mock
            .Setup(m => m.GetInstrumentPriceCompressedCountAsync(It.IsAny<int>(), It.IsAny<DateTime>(),
                It.IsAny<DateTime>(), It.IsAny<AggregationFrequency?>()))
            .ReturnsAsync(fixture.Create<int>());
    ...
    public static Mock<IPortfolioRepository> CreateDefaultPortfolioRepositoryMock(this IFixture fixture)
    {
        ...
        mock
            .Setup(m => m.FindAsync(It.IsAny<int>()))
            .Returns<int>(id => Task.FromResult(new Portfolio(id, fixture.Create<string>(), fixture.Create<string>(),
                fixture.Create<string>())));
        mock
            .Setup(m => m.ExistsAsync(It.IsAny<int>()))
            .Returns(Task.FromResult(true));
    ...
    public static Mock<IPositionRepository> CreateDefaultPositionRepositoryMock(this IFixture fixture)
    {
        ...
        mock
            ...
            .Returns(Task.FromResult((IEnumerable<Position>)new List<Position>
            {
                new(fixture.Create<int>(), fixture.Create<int>(), fixture.Create<int>(), fixture.Create<string>())
            }));
        mock
            .Setup(m => m.FindAsync(It.IsAny<int>()))
            .Returns<int>(id =>
                Task.FromResult(
                    new Position(id, fixture.Create<int>(), fixture.Create<int>(), fixture.Create<string>())));
        mock
    ...
    public static Mock<IInstrumentPriceRepository> CreateDefaultInstrumentPriceRepositoryMock(this IFixture fixture)
    {
        ...
        mock
            ...
            .Returns<int, int>((instrumentId, priceId) => Task.FromResult(
                new InstrumentPrice(priceId, fixture.Create<DateTime>(), fixture.Create<DateTime>(),
                    fixture.Create<decimal>(), instrumentId)
            ));
        mock
    ...
    public static Mock<ICurrencyExchangeRateRepository> CreateDefaultCurrencyExchangeRateRepositoryMock(
        this IFixture fixture)
    {
        ...
        mock
            ...
            .Returns<string, string, DateTime>((from, to, time) =>
                Task.FromResult(new CurrencyExchangeRate(time, 1, from, to)));
        mock
    ...
    public static Mock<IChartRepository> CreateDefaultChartRepositoryMock(this IFixture fixture)
    {
        ...
        mock
            .Setup(m => m.FindAsync(It.IsAny<int>()))
            .Returns<int>(id => Task.FromResult(new Chart(id, fixture.Create<string>(),
                fixture.Create<ChartDateRange>(), fixture.Create<ChartTypeSettings>())));
        mock
