...
public class DataImportRepositoryTests : RepositoryTestBase
{
    ...
    public async Task ListAllAsync_ReturnsAllDataImports()
    {
        ...
        var second = new DataImport(Guid.NewGuid(), DateTime.UtcNow, TemplateType.Instruments, ImportStatus.Finished,
            "errorMessage");
    ...
    public async Task Add_CreatesNewDataImport()
    {
        var dataImport = new DataImport(Guid.NewGuid(), DateTime.UtcNow, TemplateType.Instruments,
            ImportStatus.Finished, "errorMessage");
    ...
    {
        var dataImport = new DataImport(Guid.NewGuid(), DateTime.UtcNow, TemplateType.Instruments, ImportStatus.Pending,
            "errorMessage");
