...
namespace PortEval.Application.Models.DTOs
{
    ...
    public class ChartDto
    {
        ...
        [SwaggerSchema("Determines whether the chart's date range is fixed, or whether the chart displays data for the given ToDateRange until the current date and time.",
            Nullable = true)]
        ...
        [SwaggerSchema("Chart aggregation frequency. Only applicable for charts with types Aggregated Profit or Aggregated Performance")]
        public AggregationFrequency? Frequency { get; set; }

        [SwaggerSchema("List of chart's lines.")]
