...
public class CsvExportController : PortEvalControllerBase
{
    ...
    public CsvExportController(IInstrumentService instrumentService, IInstrumentPriceService priceService,
        IPortfolioService portfolioService, IPositionService positionService, ITransactionService transactionService,
        ICsvExportService exportService)
    {
