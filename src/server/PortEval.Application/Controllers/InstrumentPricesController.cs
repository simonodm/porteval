...
public class InstrumentPricesController : PortEvalControllerBase
{
    ...
    public async Task<ActionResult<PaginatedResponse<InstrumentPriceDto>>> GetInstrumentPrices(int instrumentId,
        [FromQuery] DateRangeParams dateRange, [FromQuery] PaginationParams pagination,
        [FromQuery] AggregationFrequency? frequency = null,
        [FromQuery] bool compressed = false)
    {
        var prices =
            await _priceService.GetInstrumentPricesPageAsync(instrumentId, pagination, dateRange, compressed,
                frequency);
    ...
    [HttpGet("at")]
    public async Task<ActionResult<InstrumentPriceDto>> GetInstrumentPriceAt(int instrumentId,
    ...
    [HttpPost]
    public async Task<ActionResult<InstrumentPriceDto>> PostPricePoint(int instrumentId,
