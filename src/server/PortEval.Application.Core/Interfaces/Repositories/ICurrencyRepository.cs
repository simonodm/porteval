...
public interface ICurrencyRepository : IRepository
{
    ...
    /// </summary>
    /// <returns>
    ///     A task representing the asynchronous retrieval operation. The task result contains an <c>IEnumerable</c>
    ///     containing all existing currencies.
    /// </returns>
    ...
    /// <returns>
    ///     A task representing the asynchronous search operation. The task result contains the currency entity with the
    ///     supplied ID if it exists, null otherwise.
    /// </returns>
    ...
    /// </summary>
    /// <returns>
    ///     A task representing the asynchronous retrieval operation. The task result contains the default currency
    ///     entity.
    /// </returns>
