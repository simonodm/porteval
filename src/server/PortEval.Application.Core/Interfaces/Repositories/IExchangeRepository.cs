...
namespace PortEval.Application.Core.Interfaces.Repositories
{
    ...
    public interface IExchangeRepository : IRepository
    {
        ...
        /// </summary>
        /// <returns>
        /// A task representing the asynchronous retrieval operation. The task result contains an <c>IEnumerable</c> containing all existing exchanges.
        /// </returns>
        ...
        /// <returns>
        /// A task representing the asynchronous retrieval operation. The task result contains the exchange with the specified symbol if it exists, <c>null</c> otherwise.
        /// </returns>
