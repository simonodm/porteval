...
public interface ICurrencyConverter
{
    ...
    /// <returns>
    ///     A collection of exchange rates created by multiplying the provided collections. For example, at time T it will
    ///     contain the product
    ///     of the exchange rate at T from the first collection and the exchange rate at T from the second collection.
    /// </returns>
    public IEnumerable<CurrencyExchangeRateDto> CombineExchangeRates(IEnumerable<CurrencyExchangeRateDto> first,
        IEnumerable<CurrencyExchangeRateDto> second);
    ...
    /// <returns>
    ///     A collection of chart points with their values multiplied by the appropriate exchange rates from
    ///     <paramref name="exchangeRates" />.
    /// </returns>
    public IEnumerable<EntityChartPointDto> ConvertChartPoints(IEnumerable<EntityChartPointDto> chartPoints,
    ...
    /// <param name="exchangeRates">Exchange rates to convert by.</param>
    /// <returns>
    ///     A collection of transactions with their prices multiplied by the appropriate exchange rates from
    ///     <paramref name="exchangeRates" />.
    /// </returns>
    public IEnumerable<TransactionDto> ConvertTransactions(IEnumerable<TransactionDto> transactions,
        IEnumerable<CurrencyExchangeRateDto> exchangeRates);
    ...
    public IEnumerable<InstrumentPriceDto> ConvertInstrumentPrices(IEnumerable<InstrumentPriceDto> instrumentPrices,
        IEnumerable<CurrencyExchangeRateDto> exchangeRates);
}