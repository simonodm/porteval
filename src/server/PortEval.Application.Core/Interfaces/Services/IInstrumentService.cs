...
namespace PortEval.Application.Core.Interfaces.Services
{
    ...
    public interface IInstrumentService
    {
        ...
        /// <returns>
        /// A task representing the asynchronous retrieval operation.
        /// Task result contains an <see cref="OperationResponse{T}"/> containing an <see cref="IEnumerable{T}"/> containing retrieved stock exchanges.
        /// </returns>
        ...
        /// <returns>
        /// A task representing the asynchronous retrieval operation.
        /// Task result contains an <see cref="OperationResponse{T}"/> containing an <see cref="IEnumerable{T}"/> of <see cref="EntityChartPointDto">EntityChartPointDto</see>s containing the instrument's profit in individual intervals.
        /// </returns>
        ...
        /// <returns>
        /// A task representing the asynchronous retrieval operation.
        /// Task result contains an <see cref="OperationResponse{T}"/> containing an <see cref="IEnumerable{T}"/> of <see cref="EntityChartPointDto">EntityChartPointDto</see>s containing the instrument's performance in individual intervals.
        /// </returns>
