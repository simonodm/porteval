...
public interface ICsvImportService
{
    ...
    /// </returns>
    public Task<OperationResponse<CsvTemplateImportDto>> StartImportAsync(Stream inputFileStream,
    ...
    /// <returns>
    ///     An <see cref="OperationResponse{T}" /> containing a stream to the import's error log if it exists, <c>null</c>
    ///     otherwise.
    /// </returns>
