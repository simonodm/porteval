...
public interface IPortfolioService
{
    ...
    ///     Task result contains a <see cref="OperationResponse{T}" /> containing an <see cref="IEnumerable{T}" /> containing
    ///     the retrieved portfolio DTOs.
    /// </returns>
    ...
    /// <returns>
    ///     A task representing the asynchronous retrieval operation. Task result contains a
    ///     <see cref="OperationResponse{T}" /> containing  the desired portfolio DTO if it exists, null otherwise.
    /// </returns>
    ...
    /// <returns>
    ///     A task representing the asynchronous retrieval operation.
    ///     Task result contains a <see cref="OperationResponse{T}" /> containing the latest portfolio value DTO before the
    ...
    /// <returns>
    ///     A task representing the asynchronous retrieval operation.
    ///     Task result contains a <see cref="OperationResponse{T}" /> containing an
    ///     <see cref="EntityProfitDto">EntityProfitDto</see> containing the portfolio's profit.
    /// </returns>
    ...
    ///     A task representing the asynchronous retrieval operation.
    ///     Task result contains a <see cref="OperationResponse{T}" /> containing an
    ///     <see cref="EntityPerformanceDto">EntityPerformanceDto</see> containing the portfolio's performance.
    /// </returns>
    ...
    /// <returns>
    ///     A task representing the asynchronous retrieval operation.
    ///     Task result contains a <see cref="OperationResponse{T}" /> containing an <see cref="IEnumerable{T}" /> of
    ...
    ///     A task representing the asynchronous retrieval operation.
    ///     Task result contains a <see cref="OperationResponse{T}" /> containing an <see cref="IEnumerable{T}" /> of
    ///     <see cref="EntityChartPointDto">EntityChartPointDto</see>s containing the portfolio's profit in individual
    ///     intervals.
    /// </returns>
    ...
    /// <returns>
    ///     A task representing the asynchronous retrieval operation.
    ///     Task result contains a <see cref="OperationResponse{T}" /> containing an <see cref="IEnumerable{T}" /> off
    ///     <see cref="EntityStatisticsDto" />
    ...
    /// <returns>
    ///     A task representing the asynchronous retrieval operation.
    ///     Task result contains a <see cref="OperationResponse{T}" /> containing an <see cref="EntityStatisticsDto" />
    ///     containing the portfolio's statistics.
    /// </returns>
    ...
    ///     <see cref="OperationResponse{T}" /> containing the created portfolio.
    /// </returns>
    ...
    ///     <see cref="OperationResponse{T}" /> containing the updated portfolio.
    /// </returns>
