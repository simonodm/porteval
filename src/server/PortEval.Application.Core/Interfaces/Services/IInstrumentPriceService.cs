...
public interface IInstrumentPriceService
{
    ...
    /// </returns>
    /// <remarks>
    ///     Using this overload instead of <see cref="GetInstrumentPricesAsync(int,DateRangeParams)" /> allows the caller
    ///     to avoid an instrument existence check inherent to that method.
    /// </remarks>
