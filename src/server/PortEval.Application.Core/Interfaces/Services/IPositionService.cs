...
public interface IPositionService
{
    ...
    /// </returns>
    /// <remarks>
    ///     Using this overload instead of <see cref="GetPortfolioPositionsAsync(int)" /> allows the caller to avoid a
    ///     portfolio existence check inherent to that method.
    /// </remarks>
    ...
    /// <returns>
    ///     A task representing the asynchronous retrieval operation. Task result contains an
    ///     <see cref="OperationResponse{T}" /> containing the desired position DTO if it exists, null otherwise.
    /// </returns>
    ...
    /// <returns>
    ///     A task representing the asynchronous retrieval operation.
    ///     Task result contains an <see cref="OperationResponse{T}" /> containing the latest position value DTO before the
    ///     specified time if such exists, null otherwise.
    /// </returns>
    ...
    /// <returns>
    ///     A task representing the asynchronous retrieval operation.
    ///     Task result contains an <see cref="OperationResponse{T}" /> containing an
    ///     <see cref="EntityProfitDto">EntityProfitDto</see> containing the position's profit.
    /// </returns>
    ...
    ///     A task representing the asynchronous retrieval operation.
    ///     Task result contains an <see cref="OperationResponse{T}" /> containing an
    ///     <see cref="EntityPerformanceDto">EntityPerformanceDto</see> containing the position's performance.
    /// </returns>
    ...
    /// <returns>
    ///     A task representing the asynchronous retrieval operation.
    ///     Task result contains an <see cref="OperationResponse{T}" /> containing a <see cref="PositionBreakEvenPointDto" />
    ///     containing the position's BEP.
    /// </returns>
    ...
    ///     A task representing the asynchronous retrieval operation.
    ///     Task result contains an <see cref="OperationResponse{T}" /> containing an <see cref="IEnumerable{T}" /> of
    ///     <see cref="EntityChartPointDto">EntityChartPointDto</see>s containing the position's profit in individual
    ///     intervals.
    /// </returns>
    ...
    ///     A task representing the asynchronous retrieval operation.
    ///     Task result contains an <see cref="OperationResponse{T}" /> containing an <see cref="IEnumerable{T}" /> of
    ///     <see cref="EntityChartPointDto">EntityChartPointDto</see>s containing the position's performance in individual
    ///     intervals.
    /// </returns>
    ...
    /// <summary>
    ///     Retrieves performance and profit statistics of positions of a given portfolio for the past day, week, month, and
    ///     total.
    /// </summary>
    ...
    ///     A task representing the asynchronous retrieval operation.
    ///     Task result contains an <see cref="OperationResponse{T}" /> containing an <see cref="IEnumerable{T}" /> of
    ///     <see cref="PositionStatisticsDto" /> containing the positions' statistics.
    /// </returns>
    ...
    /// <returns>
    ///     A task representing the asynchronous retrieval operation.
    ///     Task result contains an <see cref="OperationResponse{T}" /> containing a <see cref="PositionStatisticsDto" />
    ///     containing the position's statistics.
    /// </returns>
    public Task<OperationResponse<PositionStatisticsDto>> GetPositionStatisticsAsync(int positionId);

    /// <summary>
    ///     Retrieves position's price data, which contains the position's transactions until the end of
    ///     <paramref name="dateRange" /> and the position's
    ...
    /// <returns>
    ///     A task representing the asynchronous retrieval operation.
    ///     Task result contains an <see cref="OperationResponse{T}" /> containing a <see cref="PositionPriceRangeData" />
    ///     containing the position's transactions and prices.
    /// </returns>
    ...
    /// <returns>
    ///     A task representing the asynchronous retrieval operation.
    ///     Task result contains an <see cref="OperationResponse{T}" /> containing a <see cref="PositionPriceListData" />
    ///     containing the position's transactions and prices.
    /// </returns>
    ...
    /// <returns>
    ///     A task representing the asynchronous creation operation. Task result contains an
    ///     <see cref="OperationResponse{T}" /> containing the newly opened position.
    /// </returns>
    ...
    /// <param name="options">A DTO containing client's request body.</param>
    /// <returns>
    ///     A task representing the asynchronous update operation. Task result contains an
    ///     <see cref="OperationResponse{T}" /> containing the updated position.
    /// </returns>
