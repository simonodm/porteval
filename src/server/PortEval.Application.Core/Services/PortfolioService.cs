...
namespace PortEval.Application.Core.Services
{
    ...
    public class PortfolioService : IPortfolioService
    {
        ...
        public PortfolioService(IPortfolioRepository portfolioRepository, ICurrencyRepository currencyRepository, IPositionService positionService, ICurrencyExchangeRateService exchangeRateService, IPortfolioQueries portfolioDataQueries, IPositionValueCalculator valueCalculator, IPositionProfitCalculator profitCalculator, IPositionPerformanceCalculator performanceCalculator, IPortfolioStatisticsCalculator statisticsCalculator, IPortfolioChartDataGenerator chartDataGenerator, ICurrencyConverter currencyConverter)
        {
        ...
        /// <inheritdoc />
        public async Task<OperationResponse<EntityProfitDto>> GetPortfolioProfitAsync(int portfolioId, DateRangeParams dateRange)
        {
            var portfolio = await _portfolioDataQueries.GetPortfolioAsync(portfolioId);
            if (portfolio == null)
            {
        ...
        /// <inheritdoc />
        public async Task<OperationResponse<EntityPerformanceDto>> GetPortfolioPerformanceAsync(int portfolioId, DateRangeParams dateRange)
        {
            var portfolio = await _portfolioDataQueries.GetPortfolioAsync(portfolioId);
            if (portfolio == null)
            {
            ...
            DateRangeParams dateRange, AggregationFrequency frequency, string targetCurrencyCode = null)
        {
            ...
            if (!string.Equals(portfolio.CurrencyCode, targetCurrencyCode, StringComparison.CurrentCultureIgnoreCase))
            {
                var exchangeRatesResponse =
                    await _exchangeRateService.GetExchangeRatesAsync(portfolio.CurrencyCode, targetCurrencyCode, dateRange.SetFrom(DateTime.MinValue));
        ...
        /// <inheritdoc />
        public async Task<OperationResponse<IEnumerable<EntityChartPointDto>>> ChartPortfolioPerformanceAsync(int portfolioId, DateRangeParams dateRange, AggregationFrequency frequency)
        {
            var portfolio = await _portfolioDataQueries.GetPortfolioAsync(portfolioId);
            if (portfolio == null)
            {
        ...
        /// <inheritdoc />
        public async Task<OperationResponse<IEnumerable<EntityChartPointDto>>> ChartPortfolioAggregatedProfitAsync(int portfolioId,
            DateRangeParams dateRange, AggregationFrequency frequency, string targetCurrencyCode = null)
        {
            var portfolio = await _portfolioDataQueries.GetPortfolioAsync(portfolioId);
            if (portfolio == null)
        ...
        /// <inheritdoc />
        public async Task<OperationResponse<IEnumerable<EntityChartPointDto>>> ChartPortfolioAggregatedPerformanceAsync(int portfolioId, DateRangeParams dateRange, AggregationFrequency frequency)
        {
            var portfolio = await _portfolioDataQueries.GetPortfolioAsync(portfolioId);
            if (portfolio == null)
            {
