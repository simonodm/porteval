...
namespace PortEval.Application.Core.Services
{
    ...
    public class CurrencyExchangeRateService : ICurrencyExchangeRateService
    {
        ...
        /// <inheritdoc />
        public async Task<OperationResponse<CurrencyExchangeRateDto>> GetExchangeRateAtAsync(string currencyFrom, string currencyTo, DateTime
            time)
        {
        ...
        /// <inheritdoc />
        public async Task<OperationResponse<IEnumerable<CurrencyExchangeRateDto>>> GetExchangeRatesAsync(string currencyCode,
            DateTime time)
        {
        ...
        /// <inheritdoc />
        public async Task<OperationResponse<IEnumerable<CurrencyExchangeRateDto>>> GetExchangeRatesAsync(string currencyFrom,
