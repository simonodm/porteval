...
public class PortfolioChartDataGenerator : PositionBasedChartDataGenerator, IPortfolioChartDataGenerator
{
    ...
    /// <inheritdoc />
    public IEnumerable<EntityChartPointDto> ChartProfit(PortfolioPositionsPriceListData portfolioData,
        DateRangeParams dateRange, AggregationFrequency frequency)
    {
    ...
    /// <inheritdoc />
    public IEnumerable<EntityChartPointDto> ChartPerformance(PortfolioPositionsPriceListData portfolioData,
        DateRangeParams dateRange, AggregationFrequency frequency)
    {
    ...
    /// <inheritdoc />
    public IEnumerable<EntityChartPointDto> ChartAggregatedProfit(PortfolioPositionsPriceListData portfolioData,
        DateRangeParams dateRange, AggregationFrequency frequency)
    {
    ...
    /// <inheritdoc />
    public IEnumerable<EntityChartPointDto> ChartAggregatedPerformance(PortfolioPositionsPriceListData portfolioData,
        DateRangeParams dateRange, AggregationFrequency frequency)
    {
