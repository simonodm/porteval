...
public abstract class ChartDataGeneratorBase
{
    ...
    /// </summary>
    private static readonly Dictionary<AggregationFrequency, TimeSpan> FrequencyRangeLimits =
        new()
        {
    ...
    /// <summary>
    ///     Divides the supplied date range into intervals based on the supplied aggregation frequency. Intervals are adjusted
    ///     for calendar dates
    ///     (i.e. a frequency of 1 month means that the interval will start on the first day of the month and end on the last
    ///     day of the month,
    ...
    protected IEnumerable<DateRangeParams> GetAggregatedRanges(DateTime from, DateTime to,
    ...
    /// <summary>
    ///     Limits the supplied date range start in accordance to maximum durations allowed for each frequency. This is done to
    ///     avoid extreme scenarios like
